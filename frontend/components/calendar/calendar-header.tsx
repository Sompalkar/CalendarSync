...
export function CalendarHeader({ onCreateEvent }: CalendarHeaderProps) {
  const { currentView, setCurrentView, currentDate, setCurrentDate } = useCalendarStore()
  ...
  const formatCurrentDate = () => {
    ...
    if (currentView === "month") {
      ...
      return isToday ? "Today" : date.toLocaleDateString("en-US", { weekday: "long", month: "long", day: "numeric" })
    }
  }
    ...
    <div className="flex items-center justify-between w-full">
      <div className="flex items-center space-x-6">
        <div className="flex items-center space-x-4">
          ...
          <h1 className="text-xl font-semibold text-neutral-900 min-w-0">{formatCurrentDate()}</h1>
      ...
      <div className="flex items-center space-x-2">
        ...
        <Button variant="ghost" size="icon" className="relative h-8 w-8 hover:bg-neutral-100">
