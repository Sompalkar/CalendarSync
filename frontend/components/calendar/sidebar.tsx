...
//         <Button onClick={onCreateEvent} className="w-full justify-start bg-blue-600 hover:bg-blue-700">
...
import { Card, CardContent, CardHeader, CardTitle } from "@/components/ui/card"
import { Badge } from "@/components/ui/badge"
import { Calendar, Clock, Settings, Plus, MoreHorizontal } from "lucide-react"
import { useState } from "react"
...
export function Sidebar({ onCreateEvent }: SidebarProps) {
  ...
  const upcomingEvents = [
    { id: 1, title: "Team Meeting", time: "2:00 PM", date: "Today", color: "bg-emerald-500" },
    { id: 2, title: "Project Review", time: "10:00 AM", date: "Tomorrow", color: "bg-blue-500" },
    { id: 3, title: "Client Call", time: "3:30 PM", date: "Friday", color: "bg-purple-500" },
  ]
  ...
  return (
    <div className="flex-1 overflow-y-auto p-6 space-y-6">
      ...
      <Card className="border-neutral-200 shadow-none">
        <CardHeader className="pb-4">
          <CardTitle className="text-sm font-semibold text-neutral-900">Upcoming</CardTitle>
        </CardHeader>
        <CardContent className="space-y-3">
          {upcomingEvents.map((event) => (
            <div
