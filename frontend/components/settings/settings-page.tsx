              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-sm text-gray-500">Receive a weekly summary of your events</p>
                  </div>
                  <Switch
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-sm text-gray-500">Allow others to view your calendar</p>
                  </div>
                  <Switch
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-sm text-gray-500">Show when you're busy without event details</p>
                  </div>
                  <Switch
                    checked={privacy.showBusyTime}
                    onCheckedChange={(checked) => setPrivacy({ ...privacy, showBusyTime: checked })}
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-sm text-gray-500">Let others invite you to events</p>
                  </div>
                  <Switch
            ...
            <CardContent className="space-y-6">
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500 mb-3">Choose your default calendar view</p>
                  <div className="grid grid-cols-3 gap-3">
                    <Button variant="outline" className="justify-center bg-transparent">
                      Month
                    </Button>
                    <Button variant="default" className="justify-center bg-blue-600">
                      Week
                    </Button>
                    <Button variant="outline" className="justify-center bg-transparent">
                      Day
